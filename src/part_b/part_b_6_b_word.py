...
def word_rnn_model(x):
    ...
    cell1 = tf.nn.rnn_cell.GRUCell(HIDDEN_SIZE, name='layer_1')
    states1, encoding1 = tf.nn.static_rnn(cell1, word_list, dtype=tf.float32)
    cell2 = tf.nn.rnn_cell.GRUCell(HIDDEN_SIZE, name='layer_2')
    _, encoding2 = tf.nn.static_rnn(cell2, states1, dtype=tf.float32)
